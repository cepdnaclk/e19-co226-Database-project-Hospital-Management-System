            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start " id="menu">
              ...
              <li>
                <Link to='/PProfile' className="nav-link px-0 align-middle">
                  <i className="fs-4 bi-person" style={{ color: ' #042e5b', fontSize: '30px', backgroundColor: 'white', padding: '5px', borderRadius: '5px' }}></i> <span className="ms-1 d-none d-sm-inline text-white" style={{ color: ' #042e5b', fontSize: '25px' }}><b>Profile</b></span>
                </Link>
              </li>
              <li>
